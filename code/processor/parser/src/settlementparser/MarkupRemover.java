...
public class MarkupRemover {
	...
	public String parseCollapsibleList(String modifiedText){
		Pattern p11 = Pattern.compile("\\{\\{Collapsible list(.*?)\\}\\}", Pattern.DOTALL);
		Matcher m11 = p11.matcher(modifiedText);
		String workgroup11 = "";
		while (m11.find()) {
			workgroup11 = m11.group();
			System.out.println("PRINT MATCHER: "+workgroup11);
			modifiedText=modifiedText.replace(workgroup11,"");
		}
